...
def args():
    ...
    parser.add_argument("--inp", type=str, default='./dataset/cls/', help="Directory with .mat files")
    parser.add_argument("--out", type=str, default='./dataset/cls_png/', help="Directory where to save .png files")
