...
class GCI(nn.Module):
    ...
    def _init_params(self):
        ...
        self.fc_deep = nn.Sequential(self._conv2d(256, 512, 1, bias=False), self._bnorm(512), nn.ReLU())

        self.fc_skip = nn.Sequential(self._conv2d(256, 256, 1, bias=False), self._bnorm(256, affine=False))

        self.fc_cls = nn.Sequential(self._conv2d(256, 256, 1, bias=False), self._bnorm(256), nn.ReLU())
